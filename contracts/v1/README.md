...
- **ดึงเป็นครั้งๆ (ใช้อยู่ตอนนี้)**: DXS ตอบเฉพาะเครื่องที่อยู่ในไทย VPS จึงไม่เรียกเอง ไฟล์ข้อ 14–16 มาจากการสั่ง `bkk-fetch` บนเครื่องในไทยเป็นครั้งๆ แล้วคัดลอกไปที่ VPS · รอบของ VPS ใส่ไฟล์ที่ผ่านสัญญาใน manifest ได้ไม่เกิน 24 ชม. หลัง `fetched_at` และ **ไม่มีสถานะแหล่ง `bma_dxs`** ผู้ใช้ข้อมูลต้องดูอายุจาก `fetched_at` เท่านั้น · เว็บต้องบอกว่า “ไม่ได้อัปเดตอัตโนมัติ” เมื่อเก่ากว่า 45 นาที และห้ามแสดงรายงานถนน (ข้อ 16) ของวันอื่นเป็นสถานการณ์วันนี้
