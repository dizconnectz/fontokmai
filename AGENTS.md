...
- **DXS** (2 เรื่องที่ต้องทำเอง): (1) บรรทัดที่สองของ `C:\Users\User\.fontokmai\dxs_key.txt` ถูก DXS ตอบว่ารหัสผิด ให้ตรวจว่า DXS ใช้รหัสผ่านที่ login หรือรหัสเฉพาะสำหรับเรียกบริการ (2) เลือกทางแก้ที่ DXS ไม่ตอบ IP ของ VPS: ขอให้ กทม. อนุญาตผ่านช่องทางของ DXS หรือใช้เครื่องในไทยเป็นตัวดึง
