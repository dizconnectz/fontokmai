...
> อัปเดตล่าสุด: 2026-09-26 00:53 ICT (Claude) · เวลาเป็น ICT (UTC+7) · วันที่แบบ ISO (ค.ศ.)
...
|---|---|---|---|---|
| Claude | 2026-09-26 00:44 | `pipeline/`, `contracts/v1/`, `scripts/gen-ts-types.sh`, `.github/workflows/`, `apps/web/` (เฉพาะ base path สำหรับ GitHub Pages: vite.config.ts, index.html, public/*, src/data.ts, src/App.tsx), `docs/design/fontokmai-design.md` (4.6, 12), `docs/sources.md`, `deploy/vps/`, AGENTS.md (A6, C2, D) | (1) ผู้ใช้เลือก GitHub Pages: deploy เว็บ (2) ประวัติน้ำท่วมถนน `ref/road_flood_history.json`: ตัวสร้างจากข้อมูลเปิด กทม. + iTIC/Longdo, สัญญา + ตัวอย่างให้ Codex, เผยแพร่บน VPS | P1 ถนนน้ำท่วม |
