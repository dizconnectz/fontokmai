...
5. **Claude — ThaiWater คู่ขนาน**: ตรวจเงื่อนไขการจัดเก็บ ประมวลผล และสำรองนอกเครื่องก่อน แล้วทำ adapter + fixtures และเก็บ archive (ฝน, เซนเซอร์น้ำท่วมถนน, ระดับน้ำคลอง) เฉพาะตามสิทธิ์ที่ตรวจได้ เพราะ private เป็นการจำกัดผู้เข้าถึง ไม่ใช่ใบอนุญาต · ยังไม่เผยแพร่จนกว่าจะได้สิทธิ์จาก สสน. (ผู้ใช้ส่งคำขอ Claude ร่างให้) และห้ามเผยแพร่เพียงเพราะลบชื่อแหล่ง
...
- **ฝนและน้ำที่วัดได้**: ThaiWater (สาธารณะแต่ไม่มีเอกสารทางการ และสิทธิ์ยังไม่ชัด ต้องขออนุญาต สสน. ก่อนเผยแพร่), ชุดข้อมูลเปิดของ สสน. (CC BY-NC: ระดับน้ำ 10 นาทีและฝนของสถานี สสน. ตั้งแต่ 2019 ช้า 1–2 เดือน ใช้ทำประวัติ), RID Reservoir API, TMD Open API และ RSS รายงานอากาศรายสถานี
...
- **ถนนที่น้ำท่วมใน กทม.** (ผู้ใช้ถาม 2026-09-25): ได้ 3 ทาง ได้แก่ เซนเซอร์ 236 จุดและอุโมงค์ 8 แห่ง (สด), รายงานน้ำท่วมขังรายวันของเจ้าหน้าที่ (หลังเกิดเหตุ) และสถิติรายปี 2021–2025 (CC BY) · สองทางแรกต้องได้อนุญาตก่อนแสดงบนแผนที่ ระหว่างนี้ใช้ลิงก์ออก · แสดงเป็นจุดวัดหรือช่วงถนนตามรายงาน ไม่ระบายทั้งเส้นถนน
